...
|---------------------------|--------------------------------|--------------------------------|
| Predictia aglomeratiei daca se realizeaza anumite investitii in diverse sectoare (ex: educatie, infrastructura) | Graph Neural Network care ofera o predictie asupra aglomeratiei | RN + web service |
| Predictia oraselor care au sanse mari de deveni aglomerate | Graph Neural Network care ofera o predictie asupra aglomeratiei | RN + web service |
...
**Descriere detaliată:**
Am generat datele random intre anumite valori care fac sens pentru respectivii parametrii. Edgurile graph-ului au fost realizate in functie de distanta dintre orase. 
