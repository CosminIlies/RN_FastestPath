...
| **Exp#** | **Modificare față de Baseline (Etapa 5)** | **Accuracy** | **R2-score** | **Timp antrenare** | **Observații** |
|----------|------------------------------------------|--------------|--------------|-------------------|----------------|
...
|----------------|-------------------|------------------------|-----------------|
| **Model incarcat** | `city_agglomeration_gnn.pt` | `city_agglomeration_gnn.pt` | +20% accuracy |
...
2. **State Machine actualizat:**
   - Stare nouă adăugată: SAVE_MODEL -> salveaza modelul intr-un fisier .pt
   - Stare nouă adăugată: LOAD_MODEL -> incarca modelul modelul in memorie
   - Tranziție modificată: daca exista un models/city_agglomeration_gnn.pt atuci trecem in LOAD_MODEL, daca nu atunci generam datele, antrenam modeulu si in salvam.

3. **UI îmbunătățit:**
   - Am adaugat un chart care arata diferenta dintre aglomeratia prezisa si cea reala, a ajutat foarte mult pentru a antrena modelul
...
1. **Arhitectură:** 3 layere de GCN uri
2. **Regularizare:** Dropout
3. **Learning rate:** scheduler
4. **Augmentări:** [tipuri relevante domeniului]

**Criteriu de selecție model final:** R2 cel mai mare
...
2. neuroni hidden layer 64 - 128 ->  R2 0.617 - 0.65, +8% acc
3. silu -> leaky_relu -> +4% acc, R2 0.65 - 0.81
4. residual connections -> +9% acc, R2 0.81 - 0.93
```
...
**Obiective atinse:**
- [x] Model RN funcțional cu accuracy 90% pe test set
...
**Obiective neatinse:**
- [ ] deployment în cloud
- [ ] O interfata cu un UI/UX mai bun
```
...
1. Scrierea de date reale
2. Tratat probleme de concurenta

**Pe termen mediu (3-6 luni):**
1. Sistem Ai prin care sa tina la curent reteaua neuronala folosind striri si bloguri locale
2. Imbunatatit arhitectura
3. Documentat daca este posibili mutarea retelei neuronale pe frontend cu wasm (ONNX)
...
**Tehnice:**
1. Biblioteca PyTorch
2. Ce este un GNN, GCN si in ce contexte se pot folosi
3. Residual connection

**Proces:**
1. Documentarea inainte a proiectului este foarte importanta
2. Mereu exista loc de imbunatatiri si progres
